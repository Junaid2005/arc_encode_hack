...
def main():
                ...
                if isinstance(data, dict) and "abi" in data:
                    ...
                    if isinstance(abi, list):
                        ...
                        if contract_name == "TrustMintSBT":
                            ...
                            found = [f["name"] for f in abi if f.get("type") == "function"]
                    ...
                    print(f"    ✗ Invalid ABI structure (expected dict with 'abi' key or list)")
                    issues.append(f"Invalid ABI structure in {p}")
    ...
    if issues:
        ...
        if any("TRUSTMINT_SBT_ABI_PATH" in issue for issue in issues):
            print("\n2. Add to .env file:")
            print("   TRUSTMINT_SBT_ABI_PATH=blockchain_code/out/TrustMintSBT.sol/TrustMintSBT.json")
